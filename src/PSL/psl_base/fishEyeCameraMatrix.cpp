...
template <typename NumericType>
void FishEyeCameraMatrix<NumericType>::scaleK(NumericType scale_x,
                                              NumericType scale_y) {
  cam.scaleK(scale_x, scale_y);
}

template <typename NumericType>
const Eigen::Matrix<NumericType, 3, 3> &
FishEyeCameraMatrix<NumericType>::getK() const {
  return cam.getK();
}

template <typename NumericType>
const Eigen::Matrix<NumericType, 3, 3> &
FishEyeCameraMatrix<NumericType>::getR() const {
  return cam.getR();
}

template <typename NumericType>
const Eigen::Matrix<NumericType, 3, 1> &
FishEyeCameraMatrix<NumericType>::getT() const {
  return cam.getT();
}
...
template <typename NumericType>
void FishEyeCameraMatrix<NumericType>::setKRTXi(
    const Eigen::Matrix<NumericType, 3, 3> &K,
    const Eigen::Matrix<NumericType, 3, 3> &R,
    const Eigen::Matrix<NumericType, 3, 1> &T, NumericType xi) {
...
FishEyeCameraMatrix<NumericType>::unprojectPoint(NumericType x, NumericType y,
...
template <typename NumericType>
Eigen::Matrix<NumericType, 2, 1>
FishEyeCameraMatrix<NumericType>::projectPoint(NumericType x, NumericType y,
                                               NumericType z) const {
...
template <typename NumericType>
const Eigen::Matrix<NumericType, 3, 1> &
FishEyeCameraMatrix<NumericType>::getC() const {
  return cam.getC();
}
