...
template <typename NumericType> CameraMatrix<NumericType>::CameraMatrix() {
  this->K.setIdentity();
  this->R.setIdentity();
  this->T.setZero();
...
CameraMatrix<NumericType>::CameraMatrix(const Matrix<NumericType, 3, 3> &K,
                                        const Matrix<NumericType, 3, 3> &R,
                                        const Matrix<NumericType, 3, 1> &T) {
  this->K = K;
  this->R = R;
  this->T = T;
...
template <typename NumericType>
CameraMatrix<NumericType> &CameraMatrix<NumericType>::
operator=(const CameraMatrix<NumericType> &otherCameraMatrix) {
  this->K = otherCameraMatrix.K;
  this->R = otherCameraMatrix.R;
  this->T = otherCameraMatrix.T;
...
template <typename NumericType>
void CameraMatrix<NumericType>::setKRT(const Matrix<NumericType, 3, 3> &K,
                                       const Matrix<NumericType, 3, 3> &R,
                                       const Matrix<NumericType, 3, 1> &T) {
  this->K = K;
  this->R = R;
...
template <typename NumericType>
const Matrix<NumericType, 4, 4> &
CameraMatrix<NumericType>::getCam2Global() const {
  return cam2Global;
}
...
template <typename NumericType>
Matrix<NumericType, 4, 1>
CameraMatrix<NumericType>::unprojectPoint(NumericType x, NumericType y,
                                          NumericType depth) const {
...
template <typename NumericType>
Eigen::Matrix<NumericType, 4, 1>
    CameraMatrix<NumericType>::localPoint2GlobalPoint(
        Eigen::Matrix<NumericType, 4, 1> &localPoint) const {
