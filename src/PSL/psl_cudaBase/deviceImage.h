...
public:
  ...
  inline __host__ __device__ unsigned char *getAddr() const { return addr; }
  inline __host__ __device__ int getWidth() const { return width; }
  inline __host__ __device__ int getHeight() const { return height; }
  inline __host__ __device__ int getNumChannels() const { return numChannels; }
  inline __host__ __device__ int getPitch() const { return (int)pitch; }
  inline __host__ __device__ bool isAllocated() const { return addr != 0; }
